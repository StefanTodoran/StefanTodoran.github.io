 ...
 */
function getAllFiles(directory: fse.PathLike, recursive?: boolean) {
...
function calcSizeOfFiles(fileList: string[]) {
    let totalSize = 0;
...
function calcDirectorySize(directory: fse.PathLike) {
